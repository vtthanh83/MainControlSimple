#line 1 "..\\Libraries\\sunid_lib\\thanh\\src\\pn532_drvr.c"
...
#line 7 "..\\Libraries\\sunid_lib\\thanh\\src\\pn532_drvr.c"
...
#line 9 "..\\Libraries\\sunid_lib\\thanh\\src\\pn532_drvr.c"
...
#line 10 "..\\Libraries\\sunid_lib\\thanh\\src\\pn532_drvr.c"
...
#line 11 "..\\Libraries\\sunid_lib\\thanh\\src\\pn532_drvr.c"
...
{
  return GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0001));
}
...
#line 236 "..\\Libraries\\sunid_lib\\thanh\\src\\pn532_drvr.c"
	VTimer_Release(timerid);
  }
  else 
  {
...
pn532_error_t pn532SendCommand(const uint8_t * pbtData, const uint32_t szData, const int32_t tmo)
{
  ...
  uint8_t  abtFrame[((264) + (11))] = { 0x01, 0x00, 0x00, 0xff };
  uint32_t szFrame = 0;
