#line 1 "..\\Libraries\\sunid_lib\\src\\uartcom.c"
...
#line 2 "..\\Libraries\\sunid_lib\\src\\uartcom.c"
#line 3 "..\\Libraries\\sunid_lib\\src\\uartcom.c"
...
#line 4 "..\\Libraries\\sunid_lib\\src\\uartcom.c"
...
#line 5 "..\\Libraries\\sunid_lib\\src\\uartcom.c"
...
unsigned char USART_getchar(void)							
{
	...
	while (std_buf.count <= 0);        	
	std_buf.count--;
	c = std_buf.buffer[std_buf.rd_start++];
	std_buf.rd_start = (std_buf.rd_start == 64)?0:std_buf.rd_start;
...
void USART1_ISR(void)
{
	...
	if (USART_GetITStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0525)) == SET)
	{
		...
		{
			std_buf.count++;
			c = USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)));
			std_buf.buffer[std_buf.wr_start++] = c;
			
			std_buf.wr_start = (std_buf.wr_start == 64)?0:std_buf.wr_start;
		}
	}
}
