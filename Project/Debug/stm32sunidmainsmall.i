#line 1 "..\\Utilities\\STM32sunidMainSmall.c"
...
#line 15 "..\\Utilities\\STM32sunidMainSmall.c"
...
#line 16 "..\\Utilities\\STM32sunidMainSmall.c"




  
GPIO_TypeDef* GPIO_PORT[2] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))};

const uint16_t GPIO_PIN[2] = {((uint16_t)0x0002), ((uint16_t)0x2000)};

const uint32_t GPIO_CLK[2] = {((uint32_t)0x00000020), ((uint32_t)0x00000010)};
...
void LEDInit(Led_TypeDef Led)
{
  ...
  GPIO_PinRemapConfig(((uint32_t)0x00008000), ENABLE);
  if(Led == ALL_LED){
	  for(i = 0; i<2; i++){
