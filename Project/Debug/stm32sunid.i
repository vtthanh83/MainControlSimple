...
#line 15 "..\\Utilities\\STM32sunid.c"
...
#line 16 "..\\Utilities\\STM32sunid.c"




  
GPIO_TypeDef* GPIO_PORT[7] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)),
								((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))};

const uint16_t GPIO_PIN[7] = {((uint16_t)0x4000), ((uint16_t)0x2000), ((uint16_t)0x8000), ((uint16_t)0x0001), ((uint16_t)0x0002), ((uint16_t)0x0200), ((uint16_t)0x0002)};

const uint32_t GPIO_CLK[7] = {((uint32_t)0x00000010), ((uint32_t)0x00000010), ((uint32_t)0x00000010), ((uint32_t)0x00000020),
								((uint32_t)0x00000020), ((uint32_t)0x00000008), ((uint32_t)0x00000008)};



const uint16_t BUTTON_PIN_SOURCE[1] = {((uint8_t)0x0C)};

const uint16_t BUTTON_PORT_SOURCE[1] = {((uint8_t)0x00)};

GPIO_TypeDef* BUTTON_PORT[1] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))}; 

const uint16_t BUTTON_PIN[1] = {((uint16_t)0x1000)}; 

const uint32_t BUTTON_CLK[1] = {((uint32_t)0x00000004)};

const uint16_t BUTTON_EXTI_LINE[1] = {((uint32_t)0x01000)};

const uint16_t BUTTON_IRQn[1] = {EXTI15_10_IRQn};	


GPIO_TypeDef* SWITCH_PORT[4] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))}; 

const uint16_t SWITCH_PIN[4] = {((uint16_t)0x1000), ((uint16_t)0x2000), ((uint16_t)0x4000), ((uint16_t)0x8000)}; 

const uint32_t SWITCH_CLK[4] = {((uint32_t)0x00000008), ((uint32_t)0x00000008), ((uint32_t)0x00000008), ((uint32_t)0x00000008)};				 
...
void LEDInit(Led_TypeDef Led)
{
  ...
  if(Led == LED1 || Led == LED4 || Led == ALL_LED) GPIO_PinRemapConfig(((uint32_t)0x00008000), ENABLE);
  if(Led == ALL_LED){
	  for(i = 0; i<7; i++){
...
void BuzzerOn(int time)
{
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x0800);   
  delay_ms(time);
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x0800); 
	delay_ms(100);
}
...
void SWInit(Switch_TypeDef Switch, SwitchMode_TypeDef Switch_Mode)
{
	...
	unsigned char i = 0;
	 if(Switch == ALL_SWITCH){
	  for(i = 0; i<4; i++){
		  RCC_APB2PeriphClockCmd(SWITCH_CLK[i] | ((uint32_t)0x00000001), ENABLE);
		  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
		  ...
		  RCC_APB2PeriphClockCmd(SWITCH_CLK[Switch] | ((uint32_t)0x00000001), ENABLE);
...
void TimerInit(uint32_t period)
{
	...
	TIM2_TimeBaseInitStruct.TIM_ClockDivision = ((uint16_t)0x0000);
	TIM2_TimeBaseInitStruct.TIM_CounterMode = ((uint16_t)0x0000);
	TIM2_TimeBaseInitStruct.TIM_RepetitionCounter = ((uint16_t)0x0000);
	TIM2_TimeBaseInitStruct.TIM_Prescaler = 23;			
	TIM2_TimeBaseInitStruct.TIM_Period = period - 1;				
	TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), &TIM2_TimeBaseInitStruct);
